...
import AddUser from '../Doctors/Add'
import UpdatedUser from '../Doctors/Update'
import DeletUser from '../Doctors/Delete'
...
export default function Doctor() {
    ...
    const handleUserDelet = async () => {
        try {
            const DeletUser = await axios.delete(`http://localhost:8000/api/user/delete/${userId}`)
    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            const UpdatedUser = await axios.put(`http://localhost:8000/api/user/update/${updatedUserId}`,value)
